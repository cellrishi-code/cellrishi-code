...
[![Skills](https://skillicons.dev/icons?i=cpp,python,js,ts,react,nextjs,vite,tailwind,nodejs,firebase,docker,aws,vercel,git,github,linux,bash,vscode,html,css,threejs,matlab&theme=dark&perline=11)](https://skillicons.dev)
